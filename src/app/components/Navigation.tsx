    ...
    <section>
      ...
      <div className="hidden md:block fixed bottom-4 right-4">
              <a 
                ...
                className="bg-terracottalight hover:bg-accent text-forest-DEFAULT px-4 py-2 rounded-lg font-poppins font-medium shadow-medium transition-all duration-300 hover:scale-105"
              >
                🌱 Admin
              </a>
          </div>
